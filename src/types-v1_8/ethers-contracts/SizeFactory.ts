...
export interface SizeFactoryInterface extends utils.Interface {
  functions: {
    ...
    "createMarket((uint256,uint256,uint256,uint256,uint256,address),(uint256,uint256,uint256,uint256,uint256),(address,uint64),(address,address,address,address,address,address))": FunctionFragment;
