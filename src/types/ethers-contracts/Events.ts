...
export interface EventsInterface extends utils.Interface {
  ...
  events: {
    ...
    "CopyLimitOrders(address,address,uint256,uint256,uint256,uint256,int256,uint256,uint256,uint256,uint256,int256)": EventFragment;
    ...
    "SetUserConfiguration(address,address,address,uint256,bool,bool,uint256[])": EventFragment;
...
export type SetUserConfigurationEvent = TypedEvent<
  [string, string, string, BigNumber, boolean, boolean, BigNumber[]],
...
export interface Events extends BaseContract {
  ...
  filters: {
    ...
    "CopyLimitOrders(address,address,uint256,uint256,uint256,uint256,int256,uint256,uint256,uint256,uint256,int256)"(
      sender?: string | null,
      onBehalfOf?: string | null,
    ...
    "SetUserConfiguration(address,address,address,uint256,bool,bool,uint256[])"(
      sender?: string | null,
      onBehalfOf?: string | null,
      vault?: string | null,
