...
export interface SizeInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "getUserDefinedCopyBorrowOfferConfig"
      | "getUserDefinedCopyLoanOfferConfig"
  ...
  encodeFunctionData(
    functionFragment: "getUserDefinedCopyBorrowOfferConfig",
    values: [string],
  ): string;
  encodeFunctionData(
    functionFragment: "getUserDefinedCopyLoanOfferConfig",
    values: [string],
  ): string;
  encodeFunctionData(
